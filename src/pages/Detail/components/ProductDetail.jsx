    ...
    <div className="container">
      <div className="grid grid-cols-12 gap-5">
        <div className="col-span-8">
          <img src={product.image} alt="" className="w-full h-[790px]" />
          <div className="">
            <Tabs
              defaultActiveKey="1"
              centered
        ...
        <div className="col-span-4 space-y-4">
          ...
          <div>
            ...
            <div className="border border-black inline-flex rounded-lg items-center ">
              ...
              <span className=" border-x-2 border-black px-4 py-2">
                {count}
              </span>
              <button
                onClick={() => {
      ...
      <div>
        <div className=" text-center  font-normal ">
          <h2 className="text-4xl border-b-2 border-black pb-3 px-5 inline uppercase">
            Sản phẩm tương tự
          </h2>
